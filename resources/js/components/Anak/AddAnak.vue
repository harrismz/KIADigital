        ...
        <div class="w-1/2 p-8 bg-white">
            ...
            <form @submit.prevent="submit">
                <div v-for="(value, key) in formDetail" :key="key">
                    <my-input-vue :inputType="formDetail[key].type" v-model="form[key]" :inputKey="key"></my-input-vue>
                </div>

                <div>
                    <combo 
                        v-model="form.blood_type_id" 
                        :inputKey="blood_type_id.label" 
                        :key="blood_type_id.label" 
                        :url="blood_type_id.url" 
                        :label="blood_type_id.label"
                    />
                </div>
