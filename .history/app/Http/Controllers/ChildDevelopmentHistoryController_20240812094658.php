...
class ChildDevelopmentHistoryController extends Controller
{
    ...
    public function index(Request $request, $childId)
    {
        ...
        //         $heightData = DB::table('lhfa_girls')->where('month', $data->age)->first();
        //         $weightData = DB::table('wfl_girls')->where('length', $data->height)->first();
        //     }else{
        //         $heightlData = DB::table('lhfa_boys')->where('month', $data->age)->first();
        //         $weightData = DB::table('wfl_boys')->where('length', $data->height)->first();
        //     }
        // }
