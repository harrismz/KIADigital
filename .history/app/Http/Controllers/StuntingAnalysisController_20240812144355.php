...
class StuntingAnalysisController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($result as $data) {
            ...
            $age = $data->dob->diffInMonths($data->created_at);
            ...
            if ($data->gender == 'Perempuan') {
                $additionalData = DB::table('lhfa_girls')->where('month', $dob)->first();
                ...
                $additionalData = DB::table('lhfa_boys')->where('month', $dob)->first();
