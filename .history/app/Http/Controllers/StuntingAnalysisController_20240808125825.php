...
class StuntingAnalysisController extends Controller
{
    ...
    public function index()
    {
        ...
        $result = DB::table('child_development_history')
                        ...
                        ->select('child.id as child_id', 'child.date_of_birth as child_birth_date', 'child.gender as child_gender','chil_development_history.height as height', 'child_development_history.weight as weight', 'child_development_history.created_at as created_at')
