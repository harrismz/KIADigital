<template>
    ...
    <div class="flex flex-col min-h-24 bg-gray-100 p-6 rounded-lg">
      ...
      <div class="grid grid-cols-2 gap-4 mb-4" style="height: 200px">
        ...
        <div>
          Grafik ini menampilkan data tentang prevalensi stunting pada anak-anak usia 0-5 tahun di berbagai provinsi di Indonesia untuk tahun 2023. 
          Stunting, atau kekerdilan, adalah kondisi di mana anak-anak memiliki tinggi badan yang kurang dari standar pertumbuhan yang diharapkan karena 
          kekurangan nutrisi kronis, infeksi berulang, atau faktor-faktor lain selama periode perkembangan kritis.
        </div>
      </div>
      <div class="grid grid-cols-2 gap-4 mt-4" style="height: 200px">
        <!-- <Line :data="chartData" :options="chartOptions"/> -->
