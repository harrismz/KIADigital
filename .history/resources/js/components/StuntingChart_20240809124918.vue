<template>
    ...
    <div class="flex flex-col min-h-24 bg-gray-100 p-6 rounded-lg">
      ...
      <div class="mb-4 text-center mb-8">
        ...
        <h3 class="text-lg font-semibold text-gray-700">Grafik ini bertujuan untuk memberikan wawasan yang jelas tentang jumlah kasus stunting beserta malnutrition di Indonesia</h3>
      </div>
