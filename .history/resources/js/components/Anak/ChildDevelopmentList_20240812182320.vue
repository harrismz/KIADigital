...
.chart-container {
  ...
  margin: 0 20px; /* Adjust the margin around the arrows */
}

.my-carousel .v-carousel__control--prev {
  /* Custom margin for the previous arrow */
  margin-left: 10px; /* Example margin-left */
}

.my-carousel .v-carousel__control--next {
  /* Custom margin for the next arrow */
  margin-right: 10px; /* Example margin-right */
}

/* Optional: Hide arrows by default and show only on hover */
.my-carousel .v-carousel__controls {
  opacity: 0;
  transition: opacity 0.3s;
}

.my-carousel:hover .v-carousel__controls {
  opacity: 1;
}
}
</style>
