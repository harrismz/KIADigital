...
<script>
import { differentInMonths } from '../../utils/date';
...
export default {
  ...
  methods: {
    ...
    async fetchChartData() {
      ...
      const age = dob.map((item, index) => differentInMonths(new Date(created_at), new Date(item[index])));

      console.log(dob, created_at, age);
