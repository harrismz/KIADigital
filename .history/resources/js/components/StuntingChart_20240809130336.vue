<template>
    ...
    <div class="flex flex-col min-h-24 bg-gray-100 p-6 rounded-lg">
      ...
      <div class="ml-8 mt-10 mb-8 bg-gray-100 text-gray text-xs">
        <ul class="list-disc list-inside">
          <li>
            Grafik ini bertujuan untuk memberikan wawasan yang jelas tentang jumlah kasus stunting serta gizi buruk di Indonesia.
          </li>
        </ul>
      </div>
      <!-- {{ data }} -->
